...
save_path = "models/pretrain/dict_order_cnn_blstm_crf/lm_normal_2_layer_cell_200_we_100_ce_100_lr_0.0005_dropout_0.8_cnn_1_30_2_30_3_40"
...
test_word_data, test_char_data, test_dict_order_feats, test_label, test_seqlen = load_data("data/VTB-train-dev-test/test-BIE", "data/VTB-train-dev-test/test-inline")
...
#######
sentences = []
with open("data/VTB-train-dev-test/test-inline", "r") as f:
    for row in f:
