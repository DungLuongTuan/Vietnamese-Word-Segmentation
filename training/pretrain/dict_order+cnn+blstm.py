...
class DeepCNNBLSTMSegment():
    ...
    def init_placeholder(self):
        ### placeholders
        self.word_inputs = tf.placeholder(tf.float64, [None, self.max_lstm_step, self.word_embedding_size])
...
save_path = "models/pretrain/dict_order_cnn_blstm/normal_2_layer_cell_200_we_100_ce_100_lr_0.001_dropout_0.8_cnn_1_30_2_30_3_40"
