...
save_path = "models/end_to_end/dict_order_cnn_blstm/test2"
...
train_word_data, train_char_data, train_dict_order_feats, train_label, train_seqlen = load_data("data/VTB-train-dev-test/train-BI", "data/VTB-train-dev-test/train-inline")
with open("data/VTB-train-dev-test/train_full_vocab_dict_order.pkl", "wb") as f:
	pickle.dump(train_dict_order_feats, f)
#with open("data/VTB-train-dev-test/train_full_vocab_dict_order.pkl", "rb") as f:
...
print("load dev data...")
dev_word_data, dev_char_data, dev_dict_order_feats, dev_label, dev_seqlen = load_data("data/VTB-train-dev-test/dev-BI", "data/VTB-train-dev-test/dev-inline")
with open("data/VTB-train-dev-test/dev_full_vocab_dict_order.pkl", "wb") as f:
	pickle.dump(dev_dict_order_feats, f)
#with open("data/VTB-train-dev-test/dev_full_vocab_dict_order.pkl", "rb") as f:
