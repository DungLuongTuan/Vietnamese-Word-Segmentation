...
def load_data(path):
    ...
    return word_data, char_data, labels, seqlens, syllable_model_index, syllable_model_label
...
save_path = "models/end_to_end/multi_task+dict_order+cnn+blstm+crf/xavier_2_layer_cell_200_we_100_ce_100_lr_0.001_dropout_0.8_cnn_1_30_2_30_3_40"
...
train_word_data, train_char_data, train_label, train_seqlen, syllable_model_train_index, syllable_model_train_label = load_data("data/VTB-train-dev-test/train-BIE")
...
print(np.shape(syllable_model_train_index))
print(np.shape(syllable_model_train_label))

print("load dev data...")
dev_word_data, dev_char_data, dev_label, dev_seqlen, syllable_model_dev_index, syllable_model_dev_label = load_data("data/VTB-train-dev-test/dev-BIE")
...
print(np.shape(syllable_model_dev_index))
print(np.shape(syllable_model_dev_label))
### train new model
...
segmenter.train_new_model(train_word_data, train_char_data, train_dict_order_feats, train_label, train_seqlen, dev_word_data, dev_char_data, dev_dict_order_feats, dev_label, dev_seqlen, lr, dropout, batch_size, num_epochs, save_path, syllable_model_train_index, syllable_model_train_label)
